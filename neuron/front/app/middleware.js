...
const { client, ...clientDefaultOptions } = Client;
...
export const multiClientMiddleware = (clients, customMiddlewareOptions) => {
  const middlewareOptions = { ...clientDefaultOptions, ...customMiddlewareOptions };
...
const axiosMiddleware = (client, customMiddlewareOptions, customClientOptions) => {
  const middlewareOptions = { ...clientDefaultOptions, ...customMiddlewareOptions };
